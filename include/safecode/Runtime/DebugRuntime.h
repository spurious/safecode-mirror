...
extern "C" {
  ...
  const char * pool_strchr(PPOOL sPool, const char *s, int c, const unsigned char complete);
  const char * pool_strchr_debug(PPOOL sPool, const char *s, int c, const unsigned char complete, TAG, SRC_INFO);
  const char * pool_strrchr(PPOOL sPool, const char *s, int c, const unsigned char complete);
  const char * pool_strrchr_debug(PPOOL sPool, const char *s, int c, const unsigned char complete, TAG, SRC_INFO);
  const char * pool_strstr(PPOOL s1Pool, PPOOL s2Pool, const char *s1, const char *s2, const unsigned char complete);
  const char * pool_strstr_debug(PPOOL s1Pool, PPOOL s2Pool, const char *s1, const char *s2,
  ...
  char * pool_strncat_debug(PPOOL dstPool, PPOOL srcPool, char *d, const char *s, size_t n,
                            const unsigned char complete, TAG, SRC_INFO);
  const char * pool_strpbrk(PPOOL sPool, PPOOL aPool, const char *s, const char *a, const unsigned char complete);
  const char * pool_strpbrk_debug(PPOOL sPool, PPOOL aPool, const char *s, const char *a,
                                  const unsigned char complete, TAG, SRC_INFO);
